...
class IPTVHostsGroups:
    def __init__(self):
        ...
        self.PREDEFINED_HOSTS['moviesandseries']  = ['appletrailers','3filmy','efilmytv','alltubetv','ekinomaniak','ekinotv','cdapl','iitvpl','zalukajvip','watchmovies','zalukajcom','serialnet','freediscpl', \
                                                     ...
                                                     'darshowcom','yesmoviesto','movierulzsx','allboxtv','planetstreamingcom','filmeonlineto','tainieskaiseirestv','3sktv', 'cimaclubcom', 'gledalica', \
        ...
        self.PREDEFINED_HOSTS['polish']           = ['youtube','webstream','3filmy','efilmytv','alltubetv','allboxtv','ekinomaniak','ekinotv','cdapl','cdafilmy','iitvpl','zalukajvip','watchmovies','zalukajcom','serialnet','tvpvod','ipla','tvnvod','vodpl', \
